...
Mat image_Processing(Mat imgOriginal)
{
	...
	inRange(imgHSV, Scalar(10, 5, 156), Scalar(60, 255, 255), imgThresholded); //红色
	//add(ce1, ce2, ce3, Mat());
	//imshow("0-10", ce1);
	//imshow("156-180", ce2);
	//imshow("add后", ce3);
...
int main() {
	...
	std::string folder_path = "F:\\dariy\\handian\\22070110_LN7_jpg\\m2\\*.*"; //path of folder, you can replace "*.*" by "*.jpg" or "*.png"
	std::string path = "F:\\dariy\\handian\\22070110_LN7_jpg\\m2\\";
