...
int main()
{
	std::string folder_path = "F:\\dariy\\handian\\22041504_S51_jpg\\m1\\*.*"; //path of folder, you can replace "*.*" by "*.jpg" or "*.png"
	std::string path = "F:\\dariy\\handian\\22041504_S51_jpg\\m1\\";
	...
	Mat res_th;
	Mat mask_handian_min, mask_handian_mid, mask_handian_max;
